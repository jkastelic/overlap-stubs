...
TMTrackProducer.StubDigitize = cms.PSet(
   ...
   FirmwareType    = cms.uint32(0),    # 0 = Old Thomas 2-cbin data format, 1 = new Thomas data format for daisy chain, 2-4 = reserved for demonstrator use, 9 = Systolic array data format.
