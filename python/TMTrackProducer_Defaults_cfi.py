...
TMTrackProducer = cms.EDProducer('TMTrackProducer',
  ...
  HTFillingRphi = cms.PSet(
     ...
     BusySectorNumStubs   = cms.uint32(216),
  ...
  RZfilterOpts = cms.PSet(
     ...
     MaxSeedCombinations = cms.uint32(1000),
  ...
  TrackFitSettings = cms.PSet(
     #
     #--- Options for chi2 track fitters ---
     #
     ...
     # (TrackFitLinearAlgo & ChiSquared* are chi2 fits, whilst KF* is a Kalman filter fit. The number 4 or 5 indicates if 4 or 5 helix parameters are fitted).
     # WARNING: currently only KF4ParamsComb runs without crashing!
